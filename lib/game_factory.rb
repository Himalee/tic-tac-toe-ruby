class GameFactory
  ...
  def set_players
    ...
    choice = @display.valid_set_up_players_response(players[FIRST_ELEMENT].name, players[SECOND_ELEMENT].name, players[FIRST_ELEMENT].mark, players[SECOND_ELEMENT].mark)
